...
class functions_terrorist_1 {
	displayName = "Terrorist Training";
	requiredPerkPoints = 8;
	requiredLevel = 21;
	requiredPerk = "functions_rebel_1";
	subtitle = "Level 21 Required, 8 Perk Points";
	description = "Gain access to the terrorist shops for more advanced gear";
	initScript = "maverick\talent-tree-modular\modules\maverick_perkset_1\functions\functions_terrorist_1.sqf";
	limitToSides[] = {"CIV"};
	color[] = {1,1,1,1};
};
...
class functions_advCop_1 {
	...
	requiredLevel = 18;
	requiredPerk = "";
	subtitle = "Level 18 Required, 10 Perk Points";
