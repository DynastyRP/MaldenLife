class CfgServerInfoMenu
{
   ...
   class menuItems
   {
      ...
      class first
      {
         ...
         content[] = {
            "Hey there! Welcome to Arma 3 Roleplay<br /><br />",
      ...
      class second
      {
         ...
         title = "SERVER RULES";
         content[] = {
            "<t size='1.75'>Our Rules</t><br />Visit our website for our full list of rules here: <a href='https://a3rp.co.uk' color='#56BDD6'>SERVER RULES<br />",
         };
      };
      class third
      {
      ...
      class fifth
      {
         ...
         content[] = {"To report a player, visit this link: <a href='https://a3rp.co.uk' color='#56BDD6'>REPORT PLAYER HERE</a>"
         };
      };
      class sixth
      {
         ...
         content[] = {
            "<a href='https://a3rp.co.uk' color='#56BDD6'>Join Teamspeak</a>",
            "<br />",
            "<a href='https://a3rp.co.uk' color='#56BDD6'>Website</a>"
         };
      };
      class seventh
      {
